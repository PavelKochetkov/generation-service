        ...
        <React.Fragment>
            <div className='home'>
                <div className="logoPage">
                    <img src={props.home.logo.logo} alt={props.home.logo.alt}/>
                </div>
                <div className='info'>{props.home.info}</div>
                <div className='down'>
                    <img src={props.home.down.down} alt={props.home.down.alt}/>
                </div>
            </div>
            <div className="description">
                ...
                <div className="genereateInfo">
                    <div className="genPass">
                        <img 
                            src={props.home.description.password.password} 
                    ...
                    <div className="genNum">
                        <img 
                            src={props.home.description.numbers.numbers} 
                    ...
                    <div className="genOther">
                        <img 
                            src={props.home.description.others.other} 
